classdef DobotMagician1 < RobotBaseClass
    ...
    methods
        %% Constructor
        function self = DobotMagician1(baseTr)
            if nargin < 1
        ...
        function CreateModel(self)
            ...
            link(2) = Link('d',0,        'a',0.135*2,  'alpha',0,      'offset',-pi/2, 'qlim',[deg2rad(5),deg2rad(80)]);
            link(3) = Link('d',0,        'a',0.147*2,  'alpha',0,      'offset',0, 'qlim',[deg2rad(-5),deg2rad(85)]);
            link(4) = Link('d',0,        'a',0.06*2,      'alpha',pi/2,  'offset',-pi/2, 'qlim',[deg2rad(-180),deg2rad(180)]);
            link(5) = Link('d',-0.05*2,      'a',0,      'alpha',0,      'offset',pi, 'qlim',[deg2rad(-85),deg2rad(85)]);
